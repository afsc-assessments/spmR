 ...
 model_data(argc,argv) , function_minimizer(sz)
{
  ...
  Rmsy.allocate(1,nspp,"Rmsy");
    ...
    Rmsy.initialize();
  #endif
  rnorms.allocate(1,nsims,1,npro+1,"rnorms");
  #ifndef NO_AD_INITIALIZE
    rnorms.initialize();
  #endif
  unifs.allocate(1,nsims,1,npro+1,"unifs");
  #ifndef NO_AD_INITIALIZE
    unifs.initialize();
  #endif
...
dvariable model_parameters::SRecruit(_CONST dvariable& Stmp,const int& ispp)
{
  ofstream& means_out= *pad_means_out;
  ofstream& percent_out= *pad_percent_out;
  ofstream& percent_db= *pad_percent_db;
...
dvar_vector model_parameters::SRecruit(_CONST dvar_vector& Stmp,const int& ispp)
{
  ofstream& means_out= *pad_means_out;
  ofstream& percent_out= *pad_percent_out;
  ofstream& percent_db= *pad_percent_db;
...
dvariable model_parameters::Requil(_CONST dvariable& phi,const int& ispp)
{
  ofstream& means_out= *pad_means_out;
  ofstream& percent_out= *pad_percent_out;
  ofstream& percent_db= *pad_percent_db;
...
void model_parameters::Get_Bzero(_CONST int& ispp)
{
  ofstream& means_out= *pad_means_out;
  ofstream& percent_out= *pad_percent_out;
  ofstream& percent_db= *pad_percent_db;
...
dvariable model_parameters::yield(dvariable& Ftmp, dvariable& Stmp,dvariable& Rtmp,int& ispp)
{
  ofstream& means_out= *pad_means_out;
  ofstream& percent_out= *pad_percent_out;
  ofstream& percent_db= *pad_percent_db;
